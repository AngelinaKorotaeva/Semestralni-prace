...
ALTER TABLE polozky ADD CONSTRAINT polozky_pk PRIMARY KEY ( id_jidlo,
                                                            id_objednavka );
...
ALTER TABLE jidla
    ADD CONSTRAINT parent_jidlo_fk FOREIGN KEY ( parent_jidlo )
        REFERENCES jidla ( id_jidlo );
