...
CREATE TABLE jidla (
    ...
    id_menu      INTEGER,
    parent_jidlo INTEGER NOT NULL
);

ALTER TABLE jidla ADD CONSTRAINT jidla_pk PRIMARY KEY ( id_jidlo );
...
ALTER TABLE objednavky ADD CONSTRAINT objednavky_pk PRIMARY KEY ( id_objednavka );
...
CREATE TABLE polozky (
    ...
    jidla_id_jidlo INTEGER NOT NULL,
    id_objednavka  INTEGER NOT NULL
);

ALTER TABLE polozky ADD CONSTRAINT polozky_pk PRIMARY KEY ( jidla_id_jidlo,
                                                            id_objednavka );
...
CREATE TABLE pracovnici (
    id_stravnik INTEGER NOT NULL,
    pr_telefon  INTEGER NOT NULL,
    id_pozice   INTEGER NOT NULL
);

ALTER TABLE pracovnici ADD CONSTRAINT pracovnik_pk PRIMARY KEY ( id_stravnik );

ALTER TABLE pracovnici ADD CONSTRAINT pracovnici_telefon_un UNIQUE ( pr_telefon );
...
ALTER TABLE slozky ADD CONSTRAINT slozky_pk PRIMARY KEY ( id_slozka );
...
ALTER TABLE slozky_jidla ADD CONSTRAINT slozky_jidla_pk PRIMARY KEY ( id_jidlo,
                                                                      id_slozka );
...
ALTER TABLE soubory ADD CONSTRAINT soubory_pk PRIMARY KEY ( id_soubor );
...
ALTER TABLE stavy ADD CONSTRAINT stavy_pk PRIMARY KEY ( id_stav );
...
ALTER TABLE stravnici ADD CONSTRAINT stravnici_pk PRIMARY KEY ( id_stravnik );
...
CREATE TABLE studenti (
    id_stravnik       INTEGER NOT NULL,
    st_datum_narozeni DATE NOT NULL,
...
ALTER TABLE tridy ADD CONSTRAINT tridy_pk PRIMARY KEY ( id_trida );
...
ALTER TABLE jidla
    ADD CONSTRAINT jidlo_jidlo_fk FOREIGN KEY ( parent_jidlo )
...
ALTER TABLE platby
    ADD CONSTRAINT platby_stravnici_fk FOREIGN KEY ( id_stravnik )
        REFERENCES stravnici ( id_stravnik );

ALTER TABLE polozky
    ADD CONSTRAINT polozky_jidla_fk FOREIGN KEY ( jidla_id_jidlo )
        REFERENCES jidla ( id_jidlo );
...
ALTER TABLE pracovnici
    ADD CONSTRAINT pracovnici_pozice_fk FOREIGN KEY ( id_pozice )
...
ALTER TABLE slozky_jidla
    ADD CONSTRAINT slozky_jidla_jidla_fk FOREIGN KEY ( id_jidlo )
        REFERENCES jidla ( id_jidlo );

ALTER TABLE slozky_jidla
    ADD CONSTRAINT slozky_jidla_slozky_fk FOREIGN KEY ( id_slozka )
        REFERENCES slozky ( id_slozka );

ALTER TABLE soubory
    ADD CONSTRAINT soubory_stravnici_fk FOREIGN KEY ( id_stravnik )
        REFERENCES stravnici ( id_stravnik );

ALTER TABLE stravnici
    ADD CONSTRAINT stravnici_adresy_fk FOREIGN KEY ( id_adresa )
