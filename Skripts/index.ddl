...
CREATE INDEX omez_str_fk_idx ON omezeni_stravnici(id_omezeni);
CREATE INDEX str_omez_fk_idx ON omezeni_stravnici(id_stravnik);

CREATE INDEX alerg_str_fk_idx ON alergie_stravnici(id_alergie);
CREATE INDEX str_alerg_fk_idx ON alergie_stravnici(id_stravnik);
